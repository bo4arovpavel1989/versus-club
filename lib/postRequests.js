...
var uploadAvatar = function(req, res){
			...
			form.parse(req, function(err, fields, files) {
				...
				var confirmData = {};
				confirmData._id = idLogin;
				confirmData.session = fields.session;
				simpleVerificate(confirmData, function(rep){
						console.log(rep);
						if (rep) {
...
var uploadNews = function(req, res){
			...
			try {
				form.parse(req, function(err, fields, files) {
					...
					var confirmData = {};
					confirmData._id = fields.id;
					confirmData.session = fields.session;
					verificate(confirmData, 'isEditor', function(rep) {
						if (rep) {
